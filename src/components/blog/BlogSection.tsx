  ...
  return (
    <section className="relative w-full h-screen">
                ...
                <div className="flex gap-2">
                  <button
                    ...
                    className={`w-10 h-10 rounded-full border border-white/60 flex items-center justify-center ${
                      currentSlide === 0 ? 'text-white/40 border-white/40 cursor-not-allowed' : 'text-white hover:bg-white/10'
                    }`}
                  ...
                  <button
                    ...
                    className={`w-10 h-10 rounded-full border border-white/60 flex items-center justify-center ${
                      currentSlide >= totalSlides - visibleSlides + 1 ? 'text-white/40 border-white/40 cursor-not-allowed' : 'text-white hover:bg-white/10'
                    }`}
      ...
      <div className="md:hidden w-full h-full bg-[#1A1D1F] overflow-hidden">
        <div className="relative flex flex-col gap-4 snap-y snap-mandatory h-full overflow-y-auto">
