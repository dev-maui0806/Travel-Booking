...
const hotelData = [
  ...
  },
  {
    ...
    price: 44,
    currency: 'USD',
    image: '/images/hotels/hotel3.png',
    amenities: [
      { icon: MdOutlineLocalParking, text: 'Free parking' },
      { icon: BsWifi, text: 'Free high speed internet' },
      { icon: TbAirConditioning, text: 'Air conditioner' },
          ...
          {filterOptions.map(option => (
            <button
              ...
              className={`px-4 py-2 rounded-full text-sm ${
                activeFilter === option.id ? 'bg-white text-black' : 'bg-[#1C1F22] text-gray-400'
              }`}
          ...
          {amenityFilters.map(filter => (
            <button
              ...
              className={`w-8 h-8 rounded-full flex items-center justify-center ${
                selectedAmenities.includes(filter.id) ? 'bg-[#06b6d4]' : 'bg-[#1C1F22]'
              }`}
            ...
            <div className="p-4 flex flex-col flex-grow">
              <div className="flex justify-between items-start">
                ...
                <div className="text-right">
                  ...
                  <button className="bg-[#06b6d4] text-white p-2 rounded-full mt-1">
                    <FaArrowRight />
                  </button>
                </div>
              </div>
